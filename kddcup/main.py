...
class KddCup(object):
    ...
    def train(self, inputs=[], targets=[], training_file=None, model=None, 
                batch_read=50000, batch_train=128, epochs=15, save_dir=None):
        pass

    def test(self, inputs=[], targets=[], testing_file=None, model=None):
        pass
